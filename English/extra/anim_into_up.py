...
def update_move_mob_func(mob, end_coord, frame, run_time=2, func=linear):
...
class Example(Scene):
    def construct(self):
        ...
        frame = 1 / self.camera.frame_rate
        update_triangle = update_move_mob_func(
            text,
            [1, 2, 0],
            frame,
            func=linear,
        ...
        text.add_updater(update_triangle)
